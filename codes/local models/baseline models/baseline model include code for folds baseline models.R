#This is R version for type 2 baseline models for rotation forest


#Implementation of rotation forest start#
library(rpart)
library(Matrix)
library(stringr)
...
#rotation forest codes end#

##############rotation Forest type 2 baseline model test#################
...
regression.perf_eval(dataTesting$NPP,prediction)[5]
